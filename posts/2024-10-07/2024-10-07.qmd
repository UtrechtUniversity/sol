...
description: UU Research Data Management support joins forces with the FAIR Data & Software Track of the UU Open Science Program, and the Utrecht Open Science Office to host a 2-hour interactive session on data re(use).
